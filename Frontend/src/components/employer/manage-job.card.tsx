...
const ManageJobCard: React.FC<IProps> = ({ job }) => {
  ...
  return (
    <div className="border p-4 sm:p-6 rounded-xl border-[#E9EBED] border-l-8">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
          ...
          <div className="w-fit px-3 text-center bg-[#2c3e50] rounded-lg py-1">
            <p className="text-[10px] sm:text-xs text-white font-semibold">active</p>
          </div>
        </div>
      ...
      {/* Description */}
      <div className="mt-4 text-[#6c7b7f] text-sm line-clamp-2">{job.description}</div>
      ...
      <div className="mt-6 flex justify-between gap-2 md:hidden">
