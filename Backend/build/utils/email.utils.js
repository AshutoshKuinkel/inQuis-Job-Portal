...
exports.generate_employer_application_email = exports.generate_status_update_email = exports.generate_confirmation_email = void 0;
const generate_confirmation_email = (application, job, user) => {
...
exports.generate_confirmation_email = generate_confirmation_email;
const generate_status_update_email = (application, job, user) => {
    const jobTitle = job?.title || "the job";
    const company = job?.companyName || "Company";
    const applicantName = user?.first_name || "Applicant";
    const applicantEmail = application?.contactEmail || "Not Provided";
...
exports.generate_status_update_email = generate_status_update_email;
const generate_employer_application_email = (application, job) => {
    const html = `
  <html>
    <head>
      <style>
...
exports.generate_employer_application_email = generate_employer_application_email;
